        ...
        typename CONFIG_T::bias_t    biases[CONFIG_T::n_out])
{
    ...
    for (int bb = 0; bb < CONFIG_T::n_batch; bb++) {
        ...
        dense_resource<data_T, res_T, CONFIG_T>(data_temp, res_temp, weights, biases);
...
template<class data_T, class res_T, typename CONFIG_T>
void dense_resource_rf_leq_nin_basic(
    data_T data[CONFIG_T::n_in],
    res_T  res[CONFIG_T::n_out],
    typename CONFIG_T::weight_t weights[CONFIG_T::n_in*CONFIG_T::n_out],
    typename CONFIG_T::bias_t   biases[CONFIG_T::n_out]) {
...
template<class data_T, class res_T, typename CONFIG_T>
void dense_resource_rf_gt_nin_rem0_basic(
    data_T data[CONFIG_T::n_in],
    res_T  res[CONFIG_T::n_out],
    typename CONFIG_T::weight_t weights[CONFIG_T::n_in*CONFIG_T::n_out],
    typename CONFIG_T::bias_t   biases[CONFIG_T::n_out]) {
...
template<class data_T, class res_T, typename CONFIG_T>
void dense_resource_rf_gt_nin_basic(
    data_T data[CONFIG_T::n_in],
    res_T  res[CONFIG_T::n_out],
    typename CONFIG_T::weight_t weights[CONFIG_T::n_in*CONFIG_T::n_out],
    typename CONFIG_T::bias_t   biases[CONFIG_T::n_out]) {
...
void dense_resource_basic(
    ...
    if (CONFIG_T::reuse_factor <= CONFIG_T::n_in) {
        dense_resource_rf_leq_nin_basic<data_T, res_T, CONFIG_T>(data, res, weights, biases);
    } else if (CONFIG_T::reuse_factor % CONFIG_T::n_in == 0) {
        dense_resource_rf_gt_nin_rem0_basic<data_T, res_T, CONFIG_T>(data, res, weights, biases);
    } else {
        dense_resource_rf_gt_nin_basic<data_T, res_T, CONFIG_T>(data, res, weights, biases);
    }
}
}

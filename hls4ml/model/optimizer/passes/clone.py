...
templates.get_backend('Vivado').register_templates('CloneParallel', clone_parallel_function_template, clone_parallel_config_template, clone_parallel_include_list)
